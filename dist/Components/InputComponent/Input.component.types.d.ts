...
export type PassThroughTextInputProps = Omit<InputComponentProps, 'label' | 'error' | 'iconName' | 'suggestions' | 'containerStyle' | 'onClear' | 'onSelectSuggestion' | 'disabled' | 'secureTextEntry' | 'value' | 'onBlur' | 'onChangeText' | 'onFocus'>;
...
//# sourceMappingURL=Input.component.types.d.ts.map