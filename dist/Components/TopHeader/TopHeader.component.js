 ...
 */
const _renderUserGreeting = () => (<View style={styles.greetingRow}>
...
*/
const _renderUserSection = ({ defaultOpacity }) => (<Animated.View style={[styles.userSection, { opacity: defaultOpacity }]}>
    {_renderUserGreeting()}
...
*/
const _renderSearchTrigger = ({ defaultOpacity, toggleSearch }) => (<Animated.View style={[styles.actionSection, { opacity: defaultOpacity }]}>
