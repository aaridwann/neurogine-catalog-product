...
import type { MainCardProps, ShimmerItemProps } from './MainCard.component.types';

const ShimmerItem: React.FC<ShimmerItemProps> = ({ style }) => {
...
const _renderHeader = (tagline: string) => (
...
const MainCard: React.FC<MainCardProps> = ({
  title = 'Explore Our Latest Features',
  subtitle = 'Discover seamless digital banking experience powered by modern modular architecture.',
  tagline = 'PROMOTED',
  ...
  if (isLoading) return _renderSkeletonContent();
